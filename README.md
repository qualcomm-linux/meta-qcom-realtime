...
```
## Example
To download the qcom-6.6.97-QLI.1.6-Ver.1.1.xml release
...
To download the `qcom-6.6.97-QLI.1.6-Ver.1.1_realtime-linux-1.0` release tag
```shell
git clone https://github.com/qualcomm-linux/meta-qcom-realtime -b qcom-6.6.97-QLI.1.6-Ver.1.1_realtime-linux-1.0 layers/meta-qcom-realtime
```
