...
```
## Example
To download the qcom-6.6.90-QLI.1.5-Ver.1.0.xml release
...
To download the `qcom-6.6.90-QLI.1.5-Ver.1.0_realtime-linux-1.1` release tag
```shell
git clone https://github.com/qualcomm-linux/meta-qcom-realtime -b qcom-6.6.90-QLI.1.5-Ver.1.0_realtime-linux-1.1 layers/meta-qcom-realtime
```
